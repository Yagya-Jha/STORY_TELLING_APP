                        ...
                        <ScrollView style = {styles.StoryCard}>
                            ...
                            <View style = {styles.dataContainer}>
                                <View style = {styles.titleTextContainer}>
                                    ...
                                    <Text style = {styles.storyAuthorTextt}>{this.props.route.params.story.author}</Text>
                                    <Text style = {styles.storyTitleText}>{this.props.route.params.story.created_on}</Text>
                                </View>
                            ...
                            <View style = {styles.storyTextContainer}>
                                ...
                                <Text style = {styles.moralText}>Moral of the story:- {this.props.route.params.story.moral}</Text>
                            </View>
